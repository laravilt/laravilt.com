...
<template>
    ...
    <button
        @click="open"
        class="flex items-center gap-2 rounded-lg border border-white/[0.08] bg-white/[0.03] px-3 py-1.5 text-sm text-zinc-400 transition hover:border-white/20 hover:bg-white/[0.06] hover:text-white"
    >
    ...
    <Teleport to="body">
        ...
        >
            <div v-if="isOpen" class="fixed inset-x-4 top-[15%] z-[101] mx-auto max-w-2xl overflow-hidden rounded-xl border border-white/[0.08] bg-[#0f0f0f] shadow-2xl">
                <!-- Search Input -->
                <div class="flex items-center gap-3 border-b border-white/[0.08] px-4">
                ...
                <!-- Footer -->
                <div class="flex items-center justify-between border-t border-white/[0.08] px-4 py-3 text-xs text-zinc-500">
